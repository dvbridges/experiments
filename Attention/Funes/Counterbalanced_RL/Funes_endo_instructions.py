...
ins_3 = 'First, you will see a fixation point, with boxes at each side. You will then see a coloured dot at the fixation, which will tell you with high probability where target will appear. Please push the button to see what the cues will look like.'
ins_4 = 'If the coloured dot is RED, there is a high probability that the target will appear to the LEFT of the fixation'
ins_5 = 'If the coloured dot is GREEN, there is a high probability that the target will appear to the RIGHT of the fixation'
...
ins_9 = 'Please be as quick and accurate as you can with your response. If you give an incorrect reponse, or if you fail to respond in time, you will receive onscreen feedback that your response was incorrect, or not received.'
