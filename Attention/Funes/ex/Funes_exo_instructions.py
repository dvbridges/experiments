...
ins_3 = 'First, you will see a fixation point, with boxes at each side. Please centre your gaze on the fixation. Shortly after the fixation, a cue will appear which may or may not tell you where the target will appear. Please push the button to see what the cues will look like.'
ins_4 = 'The cue below will appear once at one of these two locations.'
ins_5 = 'After the cue disappears, a target will appear in one of the boxes.'
ins_6 = 'You task is to discriminate the direction of a target arrow which appears on the screen in one of two locations. '
